...
df = pd.read_csv("C:/Users/Dell/PycharmProjects/pythonProject/Qualit-de-l-air-Auber-main/Qualit-de-l-air-Auber-main/QoD.dataset.clean.csv")
...
# Sauvegarder le DataFrame avec l'AQI calculé dans le fichier QoD.dataset.clean.csv
df.to_csv("C:/Users/Dell/PycharmProjects/pythonProject/Qualit-de-l-air-Auber-main/Qualit-de-l-air-Auber-main/QoD.dataset.clean.csv", index=False)
