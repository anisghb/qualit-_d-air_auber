...
df = pd.read_csv("C:/Users/Dell/PycharmProjects/pythonProject/Qualit-de-l-air-Auber-main/Qualit-de-l-air-Auber-main/supervisé.csv")
...
# Tracer les prédictions (y_pred) par rapport aux valeurs réelles (y_test) avec une nouvelle palette de couleurs
scatter = ax.scatter(y_test, y_pred, c=y_pred, cmap='Blues', edgecolor='k')
